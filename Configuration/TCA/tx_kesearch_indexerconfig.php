    ...
    'columns' => array(
        ...
        'type' => array(
            ...
            'config' => array(
                ...
                'items' => array(
                    ...
                    array(
                        'LLL:EXT:ke_search/Resources/Private/Language/locallang_db.xlf:tx_kesearch_indexerconfig.type.I.13',
                        'a21glossary',
                        'EXT:ke_search/Resources/Public/Icons/types_backend/selicon_tx_kesearch_indexerconfig_type_13.gif'
                    ),
                    array(
                        'LLL:EXT:ke_search/Resources/Private/Language/locallang_db.xlf:tx_kesearch_indexerconfig.type.I.14',
                        'cal',
        ...
        'fal_storage' => array(
            ...
            'config' => array(
                ...
                'renderType' => 'selectSingle',
                'items' => array(
                    array('LLL:EXT:ke_search/Resources/Private/Language/locallang_db.xlf:tx_kesearch_indexerconfig.fal_storage.dont_use_fal', -1),
                ),
                'size' => 1,
                'maxitems' => 1,
                'default' => -1,
        ...
        'cal_expired_events' => array(
            'exclude' => 0,
            'label' => 'LLL:EXT:ke_search/Resources/Private/Language/locallang_db.xlf:tx_kesearch_indexerconfig.cal_expired_events',

...
class tx_kesearch_pi2_wizicon
{
    ...
    /**
     * Reads the [extDir]/Resources/Private/Language/locallang_resultlist.xml and returns the \$LOCAL_LANG array found in that file.
     *
     * @return    The array with language labels
     */
    public function includeLocalLang()
    {
        $llFile = ExtensionManagementUtility::extPath('ke_search') . 'Resources/Private/Language/locallang_resultlist.xml';

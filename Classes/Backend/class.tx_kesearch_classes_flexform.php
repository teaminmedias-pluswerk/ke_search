...
class tx_kesearch_classes_flexform {
	 ...
	 */
	var $lang;
	var $notAllowedFields = 'uid,pid,tstamp,crdate,cruser_id,starttime,endtime,fe_group,targetpid,content,params,type,tags,abstract,language,orig_uid,orig_pid,hash,lat,lon,externalurl,lastremotetransfer';
